...
class AdminAppRequestNotification extends Notification
{
    ...
    public function toMail($notifiable)
    {
        ...
        $body = \App\Helpers\Text::replaceData($template->description, [
            ...
            'building_name' => $this->appRequest->building_name ?? 'Not specified',
            'unit_number' => $this->appRequest->unit_number ?? 'Not specified',
            'number_of_residents' => $this->appRequest->number_of_residents ?? 'Not specified',
            'service_interest' => $this->appRequest->service_interest ?? 'Not specified',
