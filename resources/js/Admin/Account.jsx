            ...
            <div className='col-sm-8'>
              <div className='tab-content pt-0'>
                <form className='tab-pane fade active show' id='email-container' role='tabpanel' aria-labelledby='email-container-tab'
                  ...
                  <h4 className='mt-0'>Update User Email</h4>
                  <InputFormGroup eRef={emailRef} label='User Email' type='email' value={session.email} required />
                  <PasswordFormGroup eRef={confirmPasswordRef} label='Confirmation Password' type='password' value={null} required />
                ...
                <form className='tab-pane fade' id='password-container' role='tabpanel' aria-labelledby='password-container-tab'
                  ...
                  <h4 className='mt-0'>Update User Password</h4>
                  <PasswordFormGroup eRef={lastPasswordRef} label='Current Password' type='password' value={null} required />
                  <PasswordFormGroup eRef={newPasswordRef} label='New Password' type='password' value={null} required />
                  <PasswordFormGroup eRef={repeatPasswordRef} label='Repeat New Password' type='password' value={null} required />
                  <button className='btn btn-primary btn-block' type='submit'>
                    <i className='fa fa-save'></i> Update
                  </button>
                </form>
...
CreateReactScript((el, properties) => {
  createRoot(el).render(<BaseAdminto {...properties} title='User Account'>
    <Account {...properties} />
  </BaseAdminto>);
})